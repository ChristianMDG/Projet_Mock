...
public interface IGuichetRepository extends JpaRepository<GuichetEntity, Long> {
    ...
    @Query("SELECT DISTINCT g FROM Guichet g " + "LEFT JOIN FETCH g.destinations d " + "LEFT JOIN FETCH d.ville " + "LEFT JOIN FETCH g.gare gare " + "LEFT JOIN FETCH gare.ville "
