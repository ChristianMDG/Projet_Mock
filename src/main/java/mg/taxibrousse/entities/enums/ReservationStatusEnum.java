...
public enum ReservationStatusEnum {
    ...
    PENDING_PAYMENT, CONFIRMED, CANCELLED_BY_USER, CANCELLED_BY_OPERATOR, COMPLETED, NO_SHOW;

    private static final Set<ReservationStatusEnum> CANCELLATION_STATUSES = Set.of(CANCELLED_BY_USER, CANCELLED_BY_OPERATOR);
