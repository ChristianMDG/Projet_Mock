...
import { useLanguagePreference } from '@/hooks/language-preference.hooks';
...
const LanguageSelector: React.FC = () => {
  ...
  const handleLanguageSelect = useCallback(
    async (lang: string) => {
      setAnchorEl(null);
      // Persist language preference for authenticated users (for SMS notifications)
      await updateLanguage(lang.toUpperCase() as LanguagePreference);
    ...
    [currentLang, location.pathname, location.search, updateLanguage, i18n, navigate],
  );
